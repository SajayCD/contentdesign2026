          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-12 mb-24">
              {[
                ...
                <div key={i} className={`relative pl-8 ${i !== 6 ? 'border-l-2 border-[var(--color-border)]' : ''}`}>
                  <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-[var(--color-accent)] border-4 border-white shadow-sm"></div>
