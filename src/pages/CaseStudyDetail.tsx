...
import { ArrowLeft, ArrowRight, AlertCircle, CheckCircle2, Clock, Presentation, FileText } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32">
        ...
        {!isMutualFunds && !isScalingOrg && !isCDAT && !isWorkshops && !isDesignAudits && (
